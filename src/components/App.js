...
arrayLetras.forEach((i) => arrayPalavraObj.push({ letra: i, acertou: false })); //cria um objeto { letra: , acerto: false} para cada letra da palavra sorteada e adiciona ao array de objetos.
...
export default function App() {
  ...
  const [jogoState, setJogoState] = useState(false);// estado que controla inicio do jogo manipulado pelo botao do componente jogo
